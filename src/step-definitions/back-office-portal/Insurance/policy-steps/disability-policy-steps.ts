...
import { inputDisabilityQuote } from "../quote-steps/disability-quote-steps";
...
When("User selectes an existing Disability quote and create policy from csv file {string}", async (filename) => {
...
When("User selectes an existing Disability policy and renew policy from csv file {string}", async (filename) => {
...
Then("System shows new policy in Disability Policy widget at Summary tab {string}", async (filename) => {
